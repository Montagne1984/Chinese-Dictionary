    ...
    public partial class BasicModels : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Consonant", x => x.ConsonantId);
                    table.UniqueConstraint("AK_Consonant_Name", x => x.Name);
                });
            migrationBuilder.CreateTable(
                name: "ToneType",
                columns: table => new
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ToneType", x => x.ToneTypeId);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Vowel", x => x.VowelId);
                    table.UniqueConstraint("AK_Vowel_Name", x => x.Name);
                });
